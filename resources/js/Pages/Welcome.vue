                ...
                >
                    ...
                    <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
                        <Link
                            ...
                            :href="route('kitchen.dashboard')" :v-if="$page.props.auth.user.role == 'kitchen_staff'"
                        ...
                        <Link
                            v-if="$page.props.auth.user"
                            :href="route('admin.dashboard')" :v-if="$page.props.auth.user.role == 'admin'"
                            class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                        >
                            Dashboard
                        </Link>
                        ...
                        <Link
                            v-if="$page.props.auth.user"
                            :href="route('delivery.dashboard')" :v-if="$page.props.auth.user.role == 'delivery_person'"
                            class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                        >
                            Dashboard
                        </Link>
